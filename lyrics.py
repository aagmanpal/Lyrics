...
def print_lirik():
    lirik = [
        ...
        ("Know you're all that I want this life", 1, 0.09),
        ("", 2, 0.0),
        ("", 2, 0.07),
        ("I'll imagine we fell in love", 1, 0.05),
        ("I'll nap under moonlight skies with you", 1.5, 0.05),
        ("I think I'll picture us, you with the waves", 1.5, 0.05),
        ("The ocean's colors on your face", 1.5, 0.09),
        ("I'll leave my heart with your air", 1.5, 0.1),
        ("So let me fly with you", 1.5, 0.1),
        ("Will you be forever with me?", 2, 0.1),
        ("", 10, 0.0),
        ("", 5, 0.06),
